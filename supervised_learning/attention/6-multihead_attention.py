...
class MultiHeadAttention(tf.keras.layers.Layer):
	...
	def call(self, Q, K, V, mask):
		"""
		Q: (batch, seq_len_q, dk), K: (batch, seq_len_v, dk), V: (batch, seq_len_v, dv)
		mask: broadcastable ou None
		Returns: output (batch, seq_len_q, dm), weights (batch, h, seq_len_q, seq_len_v)
		"""
		...
		concat_attention = tf.reshape(scaled_attention, (batch_size, seq_len_q, self.dm))
